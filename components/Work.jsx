    ...
    return (
        <motion.div
            ...
            <motion.a
                ...
                href="" className={`w-max flex items-center justify-center gap-2 border-[0.5px] rounded-full py-3 px-10 m-auto my-20 duration-500 ${isDarkMode ? "text-white border-white hover:bg-darkHover" : "text-gray-700 border-gray-700 hover:bg-lightHover"}`}>
